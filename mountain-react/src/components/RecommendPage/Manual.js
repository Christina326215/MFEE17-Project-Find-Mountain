  ...
  return (
    <div>
      <div class="container recommend-body">
        <div class="recommend-filter-wrapper">
          <h2 class="h2 recommend-h2">推薦攻略</h2>
          <table class="table recommend-table table-hover my-2 border-left border-right">
            <tbody>
              <tr>
                <th scope="row ">
                  <div class="d-flex justify-content-center mt-2 ml-1 border-right">
                    難易度
                  </div>
                </th>
                <td class="text-center">
                  <input
                    type="button"
                    value="低"
                    class="btn btn-primary recommend-filterBtn recommend-level-btn"
                  />
                </td>
                <td class="text-center">
                  <input
              ...
              <tr>
                ...
                <td class="text-center">
                  <input
                    type="button"
                    value="春季"
                    class="btn btn-primary recommend-filterBtn recommend-season-btn"
                  />
                </td>
                <td class="text-center">
                  <input
              ...
              <tr>
                ...
                <td class="text-center">
                  <input
                    type="button"
                    value="5小時內"
                    class="btn btn-primary recommend-filterBtn recommend-time-btn"
                  />
                </td>
                <td class="text-center">
                  <input
              ...
              <tr class="border-bottom">
                ...
                <td class="text-center">
                  <input
                    type="button"
                    value="郊山步道"
                    class="btn btn-primary recommend-filterBtn recommend-mountain-type-btn"
                  />
                </td>
                <td class="text-center">
                  <input
